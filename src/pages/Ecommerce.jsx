...
import { BsCyrrencyDollar } from 'react-icons/bs';
  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div
          className="bg-white dark:text-gray-200 first-letter:
            ...
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  <span
                    className="p-1.5 hover:drop-shadow-xl first-letter:
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">$45,457</span>
                </p>
